...
- Tests topic in the README file.
- Suggestion for future improvements topic in the README file.

### Changed

- User property name from `username` to `email`.
- Improved docker-compose configuration to use a `.env` file for environment variables.
